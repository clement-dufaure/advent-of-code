...
public class day8 {
	...
	public static void day8Part1() {
		List<String> data = ImportUtils.getListStringUnParLigne("./src/main/resources/2017/day8");
	...
	public static class Operation {
		...
		public String toString() {
			return "Operation [variable=" + variable + ", typeOperation=" + typeOperation + ", valeur=" + valeur + "]";
		}
	...
	public static class Condition {
		...
		@Override
		public String toString() {
			return "Condition [variable=" + variable + ", typeCondition=" + typeCondition + ", valeur=" + valeur + "]";
		}
